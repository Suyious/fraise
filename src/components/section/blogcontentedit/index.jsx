...
const BlogContentEdit = ({ value="", type="text", id, setContent, addContent, removeContent, stack, pushStack, popStack, editStack}) => {
  ...
  return(
    <div className="blog_content_main blog_content_edit">
      <Editable role={type} input_ref={content} className="articlesection_input" placeholder="Start writing your content" onChange={contentUpdate} image={image} setImage={setImage} stack={stack} pushStack={pushStack} popStack={popStack} editStack={editStack}/>
